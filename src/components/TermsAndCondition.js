      ...
      <div className="pricing-area pricing-area_1 pd-bottom-90">
        <div className="container">
          ...
          <div className="terms-content px-lg-5 text-left">
            <h4 className="mb-3">1. Service Agreement</h4>
            <p className="mb-4">
            ...
            <h4 className="mb-3">2. Service Provision</h4>
            <p className="mb-4">
            ...
            <h4 className="mb-3">3. Acceptable Use</h4>
            <p className="mb-4">
            ...
            <h4 className="mb-3">4. Equipment & Installation</h4>
            <p className="mb-4">
            ...
            <h4 className="mb-3">5. Billing & Payments</h4>
            <p className="mb-4">
            ...
            <h4 className="mb-3">6. Privacy & Data</h4>
            <p className="mb-4">
            ...
            <h4 className="mb-3">7. Limitations of Liability</h4>
            <p className="mb-4">
            ...
            <h4 className="mb-3">8. Changes to Terms</h4>
            <p className="mb-4">
